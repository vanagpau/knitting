...
# ordinal dependent variable model
...
# specify models first using lme4



# convert BDI to positive integer scale by adding +1 to all scores (this is necessary to run models as the variable cannot contain 0's)
df$BDI <- df$BDI+1
